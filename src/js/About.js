...
import wilhelma from '../media/img/wilhelma.jpg'
import turm from '../media/img/King_Kong_Panda2.png'
...
function About() {
  return (
    <div className="about">
      ...
      <div className="t-m-container" id="tmc-about-1">
      <img className="aboutImg" id="wilhelma001" src={wilhelma} alt="wilhelma" />
      ...
      <div className="t-m-container" id="tmc-about-2">
      ...
      <div className="t-m-container" id="tmc-about-3">
      ...
      <div className="t-m-container"  id="tmc-about-4">
      ...
      <img className="aboutImg" id="turm001" src={turm} alt="turm001" />
      </section>
    </div>
  );
}
