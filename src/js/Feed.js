  ...
  return (
    <div className="feed">
      <section className="feedSection">
        <p className="feedHeadlineItem" id="h01062021">01.06.2021 - Jetzt neu im Shop: Sticker und Plakate</p>
        <p className="feedHeadlineItem" id="h29052021">29.05.2021 - AKTION 20.06.2021: Stuttgart fängt die Pandas ein </p>
